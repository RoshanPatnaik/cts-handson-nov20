...
public class Laptop {
	...
	public static List<Laptop> fetchLaptops(){
		...
		laptops.add(new Laptop("Lenovo",4.0,50000,"8GB"));
		...
		laptops.add(new Laptop("Lenovo",3.5,25000,"4GB"));
		laptops.add(new Laptop("HP",4.8,45000,"8GB"));
		laptops.add(new Laptop("Acer",4.0,60000,"16GB"));
		laptops.add(new Laptop("Dell",4.5,60000,"16GB"));
		laptops.add(new Laptop("Lenovo",4.1,50000,"8GB"));
		return laptops;
	}
